...
import com.nomade.web.AccountController;
...
privileged aspect AccountController_Roo_Controller {
    ...
    void AccountController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("account_birthdate_date_format", "dd-MM-yyyy");
    }
    
    void AccountController.populateEditForm(Model uiModel, Account account) {
        uiModel.addAttribute("account", account);
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("confidentialitys", Arrays.asList(Confidentiality.values()));
        uiModel.addAttribute("genders", Arrays.asList(Gender.values()));
        uiModel.addAttribute("nationalitys", Arrays.asList(Nationality.values()));
    }
